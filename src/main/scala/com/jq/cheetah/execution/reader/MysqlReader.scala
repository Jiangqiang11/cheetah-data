package com.jq.cheetah.execution.reader
...
/**
  ...
  */
private[cheetah] class MysqlReader(@transient val sqlContext: SparkSession, val conf: CheetahConf) extends Reader{
  ...
  protected def getColumnMinAndMaxValue(): (Long, Long) = {
    ...
    tableDataDF.createTempView(tmpTable)
